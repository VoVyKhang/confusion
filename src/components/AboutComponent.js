        ...
        <Fade in key={leader.id}>
          <Media>
            ...
            <Media body className="ml-2">
              <Media heading>
                <h4 className="text-info">{leader.name}</h4>
              </Media>
    ...
    <div className="container">
      ...
      <div className="row row-content">
        <div className="col-12 col-md-6">
          <h2 className="text-info">Our History</h2>
          <p>
        ...
        <div className="col-12 col-md-5">
          <Card>
            <CardHeader className="bg-info text-white">
              <h5 className="text-center m-0">Facts At a Glance</h5>
            </CardHeader>
            <CardBody>
      ...
      <div className="row row-content">
        <div className="col-12">
          <h2 className="text-info">Corporate Leadership</h2>
        </div>
